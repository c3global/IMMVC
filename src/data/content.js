...
export const TOPICS = [
  { title: 'Mother–Daughter Relationships', emoji: '🪞' },
  { title: 'Mentorship Across Generations', emoji: '🌟' },
  { title: 'Grief & Loss', emoji: '🤍' },
  { title: 'Fertility Difficulties', emoji: '🌱' },
  { title: 'Abortion & Regret', emoji: '🕊️' },
  { title: 'Caring for an Elderly or Ill Mother', emoji: '🫶' },
  { title: 'Miscarriage', emoji: '💗' },
  { title: 'Postpartum Depression', emoji: '🌙' },
  { title: 'Body Image After Baby', emoji: '🌸' },
  { title: 'Single Motherhood', emoji: '👑' },
  { title: 'Raising Teenagers', emoji: '🔥' },
  { title: 'Parental Burnout', emoji: '🕯️' },
];
